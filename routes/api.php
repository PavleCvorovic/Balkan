...
Route::get('getNewest', 'UserController@getNewest');
...
Route::post('modPostByUser', 'UserController@modPostUser');

Route::post('getUserPostId', 'UserController@getPostbyIdUser');
